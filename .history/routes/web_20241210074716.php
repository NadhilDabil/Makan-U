...
use App\Http\Controllers\PenjualsDashboardController.p
...
Route::controller(PenjualsDashboardController::class)->group(function(){
    route::get('/dahsboard-penjual', 'index');
});
