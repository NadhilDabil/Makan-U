    ...
    <div class="container mt-5">
        ...
        <form action="{{route('update.toko')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="time" name="waktu_operasional_buka" class="form-control" id="waktu_operasional_buka"
                       value="{{ old('waktu_operasional_buka', $toko->waktu_operasional_buka) }}" required>
            </div>

            <div class="mb-3">
                <label for="waktu_operasional_tutup" class="form-label">Waktu Operasional Tutup</label>
                <input type="time" name="waktu_operasional_tutup" class="form-control" id="waktu_operasional_tutup"
                       value="{{ old('waktu_operasional_tutup', $toko->waktu_operasional_tutup) }}" required>
            </div>

            <div class="mb-3">
                <label for="lokasi_toko" class="form-label">Lokasi Toko</label>
                <input type="text" name="lokasi_toko" class="form-control" id="lokasi_toko"
                       value="{{ old('lokasi_toko', $toko->lokasi_toko) }}" required>
            </div>
